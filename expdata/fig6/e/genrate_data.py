...
MODEL_PATH = "../../../model/nips/split_unseen_drugs/seed0/model_200_split.pt"
OUTPUT_FILE = "fig4e_diffcrisp.csv"
...
print("\n图4c seen drugs数量：", len(UNSEEN_DRUGS))
print(UNSEEN_DRUGS)
...
for drug_index, drug in enumerate(UNSEEN_DRUGS, start=1):

    print(
        f"\n[{drug_index}/{len(UNSEEN_DRUGS)}] "
        f"处理药物：{drug}"
    )
...
print("理论最大行数：", len(UNSEEN_DRUGS) * len(RAW_BATCHES))
